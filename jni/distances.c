...
JNIEXPORT jlong JNICALL Java_ecoSpace_nativeFunctions_initProgressDistanceMatrix (JNIEnv *env, jclass obj) {
	int *progress=malloc(sizeof(int));
	*progress=0;
	return (jlong)progress;
}

JNIEXPORT jlong JNICALL Java_ecoSpace_nativeFunctions_computeDistanceMatrix(JNIEnv *env, jclass obj, jstring uid, jstring anuid, jlong _progress) {
...
JNIEXPORT jint JNICALL Java_ecoSpace_nativeFunctions_getProgressDistanceMatrix (JNIEnv *env, jclass obj, jlong ptr, jboolean _free) {
