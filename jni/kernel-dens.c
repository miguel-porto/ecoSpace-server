...
JNIEXPORT jint JNICALL Java_ecoSpace_nativeFunctions_computeKernelDensities(JNIEnv *env, jclass obj, jstring filename, jstring outfilename, jintArray variables,jint freqthresh,jfloat sigmapercent,jboolean downweight) {
// NOTE: "variables" must be in increasing order! 0 is latitude, 1 is longitude, 2... are the other climatic variables
	...
	int nvars,i,j,k,*freqs,ntaxafiltered=0,pcell,*mapIDs,*outIDs,d1,d2,d4,d1from,d1to,d2from,d2to,d3from,d3to,d4from,d4to,d1kern,d2kern,sidesq;
